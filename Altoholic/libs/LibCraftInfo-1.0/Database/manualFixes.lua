...
lib:DeleteCraftInfo(42613) -- Nexus Transformation, removed from the game with Nexus Crystals
...
lib:SetCraftInfo(2, 25084, 2, 38894, 33150)
lib:SetCraftInfo(2, 25084, 2, 38894, 33151)
...
lib:SetCraftInfo(2, 42974, 2, 38948, 78348)
